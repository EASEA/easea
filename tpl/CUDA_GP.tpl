...
ParametersImpl::ParametersImpl(std::string const& file, int argc, char* argv[]) : Parameters(file, argc, argv) {
	...
	if (parentPopulationSize != offspringPopulationSize) {
		std::cerr << "WARNING: Detected nbOffspring != nbParents, this may cause undefined behavior\n";
	}
...
EvolutionaryAlgorithmImpl::EvolutionaryAlgorithmImpl(Parameters* params) : CEvolutionaryAlgorithm(params){
  ...
  this->population = (CPopulation*)new PopulationImpl(this->params->parentPopulationSize,this->params->offspringPopulationSize, this->params->pCrossover,this->params->pMutation,this->params->pMutationPerGene,this->params, this->cstats); // NULL);
