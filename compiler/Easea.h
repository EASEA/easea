...
/*typedef enum {USER_CMAKE, USER_DECLARATIONS, USER_CUDA, INITIALISATION_FUNCTION, GENERATION_FUNCTION_BEFORE_REPLACEMENT, BEG_GENERATION_FUNCTION,  GP_OPCODE, GP_EVAL, INSTEAD_EVAL, END_GENERATION_FUNCTION, BOUND_CHECKING_FUNCTION, ANALYSE_USER_CLASSES, DISPLAY, MAKEFILE_OPTION, USER_FUNCTIONS, EO_INITIALISER, INIALISER, FINALIZATION_FUNCTION, CROSSOVER, MUTATOR, EVALUATOR, OPTIMISER } Searches_t;*/
